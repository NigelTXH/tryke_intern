...
import { dateParseMain, dateParse } from "../../utils.js";
import { parseState } from "../../utils.js";
export function parseGTNCN(fields){
    ...
    const { data: stateType, errors: stateError, success: successState } = parseState(state);
    ...
    const finalPacket = {
        ...
        generatedTime: dateParse(generatedTime),
        countNumber: countNumber,
        terminationCode: Number(terminationCode),
